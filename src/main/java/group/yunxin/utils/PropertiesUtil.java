...
public class PropertiesUtil
{
	...
	public final static Properties getProperties(String propertyFilePath)
	{
		...
		{
			System.err.println("propertyFilePath is null!");
			return null;
		}
	...
	{
		java.io.InputStream is = PropertiesUtil.class.getClassLoader().getResourceAsStream(propertyFilePath);
		if (is == null)
		{
		...
		{
			System.err.println("加载属性文件出错:" + propertyFilePath + e.toString());
			return null;
		}
	}
	...
	private static Properties loadPropertyFileByFileSystem(final String propertyFilePath)
	{
		...
		{
			System.err.println("FileInputStream(\"" + propertyFilePath + "\")! FileNotFoundException: " + e);
			return null;
		}
		catch (java.io.IOException e)
		{
			System.err.println("Properties.load(InputStream)! IOException: " + e);
			return null;
		}
	}
			...
			java.util.Hashtable<String, String> htKeyValue, String storeMsg)
	{
		...
		catch (FileNotFoundException e)
		{
			...
			System.err.println("~~~~~~~~path~~~XXX~~~~~" + path);
			try
			{
			...
			{
				System.err.println("FileNotFoundException! path=" + propertyFilePath);
				return false;
			}
		}
	...
	public final static void store(Properties properties, String propertyFilePath, String msg)
	{
		...
		{
			System.err.println("FileOutputStream(" + propertyFilePath + ")! FileNotFoundException: " + e);
		}
		catch (java.io.IOException e)
		{
			System.err.println("store(stream, msg)! IOException: " + e);
			e.printStackTrace();
		}
	}
	...
	public final static boolean updateValue(String propertyFilePath, String key, String newValue)
	{
		...
		{
			System.err.println("key or newValue is null!");
			return false;
		}
	...
	public final static Map<String, String> get(String file)
	{
		Set<Entry<Object, Object>> entrySet = PropertiesUtil.getProperties(file+".properties").entrySet();
